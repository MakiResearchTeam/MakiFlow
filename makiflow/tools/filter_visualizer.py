...
class FilterVisualizer(object):
    ...
    def __get_layer_output(self, layer_ind, filter_ind):
        # TODO filter_ind is never used
        loss = img
    ...
    def __process_image(self, x, former):
        ...
        :param x: A numpy-array, which could be used in e.g. imshow.
        :param former: The former numpy-array. Need to determine the former mean and variance.
    ...
    def __deprocess_image(self, x):
        ...
        :param x: A numpy-array representing the generated image.
    ...
    def generate_image(self, output_dim, color_channels, layer_ind, filter_ind,
        ...
        :param layer_ind: layer index which to take filter from.
