...
class Trainer:
    ...
    def __init__(self, path_to_json, path_where_to_save):
        """
        path_to_json - path to JSON file where the model's architecture is stored.
        path_where_to_save - (IMPORTANT!) full path to the folder where trainer will save results (tests, trained models, etc)
        """
