...
def serialize_nnr_data_point(input_image, target_image, sess=None):
    feature = {
...
def record_nnr_train_data(input_images, target_images, tfrecord_path, sess=None):
    with tf.io.TFRecordWriter(tfrecord_path) as writer:
        for input_image, target_image in zip(input_images, target_images):
            serialized_data_point = serialize_nnr_data_point(input_image, target_image, sess)
            writer.write(serialized_data_point)


# Record data into multiple tfrecords
def record_mp_nnr_train_data(input_images, target_images, prefix, dp_per_record, sess=None):
    """
